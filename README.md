...
This means that the stock YouTube app is no longer available on Android 6-7.
...
(This patch will work until Google completely shuts down the old client by [400] error.)
...
I keep the diff commits clean, so I will be able to follow the RVX updates easily by rebase my diff commits.
